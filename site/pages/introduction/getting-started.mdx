...
:::info[What is Heat?]
Heat is a unified crypto CLI for traders, AI agents, researchers, and terminal power users. It currently supports Hyperliquid, Polymarket, Aave phase 1, LI.FI-backed EVM bridging, and DefiLlama read-only market data behind one consistent output, account, and safety model.
:::
